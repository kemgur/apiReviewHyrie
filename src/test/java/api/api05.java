...
public class api05 {
    ...
    "totalprice": 445,
    "depositpaid": false,
    "bookingdates": {  // iner and outer object
        "checkin": "2020-07-27",
        "checkout": "2021-01-03"
  */
        ...
        response.then()
                ...
                .body("bookingdates.checkin",Matchers.equalTo("2018-05-28"))
                .body("bookingdates.checkout", Matchers.equalTo("2020-11-29"));
    }
}
/*  Busekilde sade de yazabiliriz. importlari degistirerek static yapabiliriz.
